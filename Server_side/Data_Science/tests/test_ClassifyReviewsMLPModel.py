...
class TestClassify(unittest.TestCase):
    ...
    def setUp(self):
        ...
        for i in range (1,len(data)):
           ...
           self.preprocessed.append(Data_Science.PreProcess.PreProcess.pre_process_review(data[i][0],"cluster"))
        # Closing the file
        file.close()
    ...
    def test_clusterReviews(self):
        ...
        result = Data_Science.MLPModel.MLPModel.clusterReviews(self.preprocessed)
