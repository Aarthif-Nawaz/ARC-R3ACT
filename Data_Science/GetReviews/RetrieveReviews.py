...
from Classification.ClassifyTest import clusterReviews
from SentimentAnalysis.PredictOverallSentiment import predict_sentiment
from TextPreprocessing.PreProcessing import reg_preprocessing, pre_processing_labelled_data
...
for review in reviews:
    print(i)
    lexicon_preprocessed.append(reg_preprocessing(review["text"]))
